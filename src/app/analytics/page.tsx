  ...
  return (
    <main className="mx-auto max-w-[1500px] px-4 py-10 sm:px-6 lg:px-8">
      <div className="max-w-3xl">
        <div className="text-sm font-black text-emerald-700">ذكاء السوق</div>
        <h1 className="mt-2 text-3xl font-black sm:text-4xl">تحليل الفرص والمنافسات وسوق المقاولات</h1>
        <p className="mt-3 leading-7 text-slate-600">قراءة سريعة للمصادر والجهات والمناطق والأنشطة الأكثر حضورًا، مع تحليلات الترسيات عندما تتوفر بياناتها الرسمية.</p>
      </div>
